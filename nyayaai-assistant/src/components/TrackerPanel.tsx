...
const steps = [
  { label: "Case Interpreted", desc: "Legal sections identified", status: "done" as const, icon: CheckCircle2 },
  { label: "Document Drafted", desc: "FIR generated & ready", status: "done" as const, icon: CheckCircle2 },
  { label: "Filed with Authorities", desc: "Waiting for response", status: "active" as const, icon: Clock },
  { label: "Auto-Nudge Scheduled", desc: "Triggers in 7 days if no response", status: "pending" as const, icon: Bell },
];
