import { User, Globe, ShieldCheck, Bell, ChevronRight } from "lucide-react";
        ...
        <div className="bg-card border border-border rounded-xl p-5">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-base font-semibold text-foreground">Rajesh Kumar</h2>
              <p className="text-xs text-muted-foreground">rajesh.kumar@email.com</p>
              <p className="text-xs text-muted-foreground">45, Gandhi Nagar, Lucknow, UP — 226001</p>
            </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">Aadhaar XXXX-XXXX-4532</p>
              </div>
